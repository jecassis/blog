    ...
    render() {
        return (
            <Html lang="en">
                <Head>
                    <meta charSet="utf-8" />
                    <meta httpEquiv="Content-Security-Policy" content="default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; font-src 'self'; media-src 'self' data:; img-src 'self' data: https://oops-blog.s3-us-west-2.amazonaws.com; connect-src 'self' https://oops-blog.s3-us-west-2.amazonaws.com; child-src 'self'; frame-src 'self'; form-action 'self'; prefetch-src 'self' https://oops-blog.s3-us-west-2.amazonaws.com; worker-src 'self'; manifest-src 'self'; object-src 'none'; base-uri 'none'; block-all-mixed-content; upgrade-insecure-requests" />
